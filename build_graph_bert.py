...
try:
    ...
    print('Using window size = {}'.format(window_size))
except:
    window_size = 3
...
with open("embed_dict_flattened.pkl", "rb") as f:
...
# select 10% validation set out of training set
# select 100% test set
...
def build_graph(start, end):
    ...
    print("Vocabulary words: {}".format(len(set(voc_word_count))))
    print("Out Of Vocabulary words: {}".format(len(set(oov_count))))
